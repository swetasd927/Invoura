...
function buildInvoicePrompt(promptText){
    ...
    Task:
        - Analyze the user's input text and produce a valid JSON object only(no explanation)
        - The JSON MUST match the schema below (include all fields even if empty).
        - Ensure all dates are ISO 'YYYY-MM-DD' strings and numeric fields are numbes.
