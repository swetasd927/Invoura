...
function convertToNPR(amount = 0, currency = "NPR") {
  const n = Number(amount || 0);
  const curr = String(currency || "NPR")
    .trim()
    .toUpperCase();
...
const Dashboard = () => {
  ...
  const [_businessProfile, setBusinessProfile] = useState(null);
            ...
            <div className="flex gap-2">
              ...
              {String(error).toLocaleLowerCase().includes("unauthorized") && (
                <button
                  ...
                  className="px-3 py-1 bg-gray-700 text text-white rounded"
                >
                  Sign in
                </button>
              )}
