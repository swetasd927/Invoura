...
const HARD_RATES = {
  ...
  //KPI computation with percentages ie(convert each invocies to inr before summarizing)
...
//recent created invoices by created in the db
